...
namespace DapperDepartments
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            PrintEmployeeReportWithDepartments("All Employees with departments", employees);
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            */
             ...
             */
         public static void PrintEmployeeReportWithDepartments(string title, List<Employee> employees)
         {
